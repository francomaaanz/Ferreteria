...
namespace Ferreteria.Controlador
{
    class ControladorProducto
    {
        ...
        //MODIFICAR producto
        public void modificarProducto(String DetalleProducto, int cantidad, Decimal PrecioNeto, Decimal PrecioIva, int IDproducto, int stockMinimo)
        {
            try
            {
        ...
        //NUEVO CLIENTE
        public void nuevoProducto(String DetalleProducto, int cantidad, Decimal PrecioNeto, Decimal PrecioIva, int stockMinimo)
        {
            try
            {
