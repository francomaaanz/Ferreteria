...
namespace Ferreteria.Vista
{
    public partial class Producto : Form
    {
        ...
        {
            ControladorProducto n = new ControladorProducto();
            n.nuevoProducto(comboBoxRubro.Text, txtDetalleProducto.Text, Convert.ToInt32(txtCantidad.Text), Convert.ToDecimal(txtPrecioNeto.Text), Convert.ToDecimal(txtPrecioIva.Text), Convert.ToInt32(txtStockMinimo.Text));
        ...
        {
            comboBoxRubro.Text = listViewProducto.FocusedItem.SubItems[1].Text;
            txtDetalleProducto.Text = listViewProducto.FocusedItem.SubItems[2].Text;
            txtCantidad.Text = listViewProducto.FocusedItem.SubItems[3].Text;
            txtPrecioIva.Text = listViewProducto.FocusedItem.SubItems[4].Text;
            txtPrecioNeto.Text = listViewProducto.FocusedItem.SubItems[5].Text;
            txtStockMinimo.Text = listViewProducto.FocusedItem.SubItems[6].Text;
